...
{
    static const int c_redDragonHealth=100;
    static const int c_redDragonAttackForce=10;
public:
    RedDragon(): Dragon("Red",c_redDragonHealth,c_redDragonAttackForce)
    {}
    std::string generateQuestion()
    {
        int left = 1 + rand()%100;
...
public:
    BlackDragon(): Dragon("Black",c_blackDragonHealth,c_blackDragonAttackForce)
    {}
    std::string generateQuestion()
    {
        int left = 1 + rand()%100;
